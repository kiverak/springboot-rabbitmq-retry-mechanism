...
public class RabbitNames {
    ...
    public static final String JURIDIC_PAYMENT_KEY = "report_juridic_entity_key";
    public static final String JURIDIC_PAYMENT_KEY_DLX = "report_juridic_entity_key_dlx";
}
